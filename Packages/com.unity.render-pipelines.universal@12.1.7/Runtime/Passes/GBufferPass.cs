...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class GBufferPass : ScriptableRenderPass
    {
        ...
        public GBufferPass(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference, DeferredLights deferredLights)
        {
            ...
            m_ShaderTagValues[2] = s_ShaderTagNPRLit;
            m_ShaderTagValues[3] = s_ShaderTagUnlit;
            ...
            m_RenderStateBlocks[2] = DeferredLights.OverwriteStencil(m_RenderStateBlock, (int)StencilUsage.MaterialMask, (int)StencilUsage.MaterialNPRLit);
            m_RenderStateBlocks[3] = DeferredLights.OverwriteStencil(m_RenderStateBlock, (int)StencilUsage.MaterialMask, (int)StencilUsage.MaterialUnlit);
